<h1 align="center">Example two</h1>

## Сервис для управлением задачами

Сервис управления задачами состоит из следующих компонентов:
...
2) Просмотр задач из базы данных;
